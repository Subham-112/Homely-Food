...
export default function OrderTrackingPage() {
  ...
  return (
    <div className="flex-1 bg-[#FAF6ED] p-4 sm:p-6 lg:p-8 flex flex-col gap-5 overflow-y-auto max-w-4xl w-full mx-auto pb-16">
      {/* Order Placed Success Banner */}
      <div className="bg-[#0B392B] text-white rounded-2xl p-5 flex items-center gap-4 shadow-md shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
        ...
        <div className="bg-[#EBF5FC] rounded-2xl p-6 border border-[#D6EBFB] shrink-0">
          <h2 className="text-lg font-bold text-[#0B251C] mb-6">
            Tracking Order
          </h2>
