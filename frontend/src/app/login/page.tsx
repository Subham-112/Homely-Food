...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 bg-[#FAF6ED] flex flex-col justify-start min-h-full">
      {/* Top Banner Food Image */}
      <div className="relative w-full h-44 sm:h-52 bg-gray-200 overflow-hidden shrink-0">
        <img
      ...
      {/* Main Login Card - Rounded top overlap */}
      <div className="relative -mt-8 flex-1 bg-white rounded-t-3xl p-6 sm:p-8 flex flex-col items-center border-t border-gray-100 shadow-lg justify-between">
        <div className="w-full flex flex-col items-center">
          {/* Circle Logo Badge */}
          <div className="w-16 h-16 rounded-full bg-[#0B392B] flex items-center justify-center -mt-14 border-4 border-white shadow-md mb-4 shrink-0">
        ...
        {/* Discreet Admin Access Link at bottom */}
